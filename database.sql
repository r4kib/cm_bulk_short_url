...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2015 at 09:52 PM
...
--
ALTER TABLE `hits`
MODIFY `sl` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=204;
--
-- AUTO_INCREMENT for table `urls`
--
ALTER TABLE `urls`
MODIFY `url_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=486;
